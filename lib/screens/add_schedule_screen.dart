            ...
            Wrap(
              ...
              children: SelectMembers.map((member) =>
                  Chip(
                    ...
                    shape: RoundedRectangleBorder(
                      side: BorderSide(color: Colors.black26, width: 1.0), // 테두리 색과 두께 설정
              ...
              onPressed: () {
                ...
                if (_startTime != null && _endTime != null) {
                  final startTimeInMinutes = _startTime!.hour * 60 +
                      _startTime!.minute;
                  final endTimeInMinutes = _endTime!.hour * 60 +
                      _endTime!.minute;

                  if (startTimeInMinutes < endTimeInMinutes) {
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                      content: Text(
                          'Schedule from ${_startTime!.format(
                              context)} to ${_endTime!.format(context)} added!'
                      ),
                    ));
                  } else {
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
